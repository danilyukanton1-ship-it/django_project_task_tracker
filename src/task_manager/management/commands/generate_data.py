    ...
    def handle(self, *args, **options):
        ...
        for i in range(0, 1000000, batch_size):
            ...
            for j in range(batch_size):
                ...
                task = Tasks(
                    ...
                    description=fake.text(),
                    status=random.choice(['created', 'started', 'completed', 'canceled', 'failed']),
        ...
        for task in tasks.iterator():
            ...
            for _ in range(number_of_comms):
                comments_to_create.append(Comments(
                    task=task,
        ...
        print(f'Total time: {minutes} minutes {seconds} seconds ({total_time:.2f} seconds)')
